...
const result = await pool.request().query(`
    SELECT 
      C.ContentID,
      B.BookID, B.Title AS BookTitle, B.Description AS BookDesc, B.Image AS BookImage,
      M.MovieID, M.Title AS MovieTitle, M.Description AS MovieDesc, M.Image AS MovieImage,
      G.GameID, G.Title AS GameTitle, G.Description AS GameDesc, G.Image AS GameImage
    FROM Content C
